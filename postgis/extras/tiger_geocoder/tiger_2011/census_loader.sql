--$Id: census_loader.sql 9826 2012-05-30 08:55:22Z robe $
--
...
IF NOT EXISTS(SELECT table_name FROM information_schema.columns WHERE table_schema = 'tiger' AND column_name = 'tract_id' AND table_name = 'tract')  THEN
	...
	COMMENT ON TABLE tiger.tract IS 'census tracts - $Id: census_loader.sql 9826 2012-05-30 08:55:22Z robe $';
	...
	COMMENT ON TABLE tiger.tabblock IS 'census blocks - $Id: census_loader.sql 9826 2012-05-30 08:55:22Z robe $';
	...
	RETURN 'Done creating census tract base tables - $Id: census_loader.sql 9826 2012-05-30 08:55:22Z robe $';
ELSE 
...
'${psql} -c "ALTER TABLE ${staging_schema}.${state_abbrev}_${table_name} RENAME geoid TO tabblock_id;  SELECT loader_load_staged_data(lower(''${state_abbrev}_${table_name}''), lower(''${state_abbrev}_${lookup_name}'')); "
